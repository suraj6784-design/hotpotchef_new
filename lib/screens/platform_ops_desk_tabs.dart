...
class _AdminProfileListState extends State<_AdminProfileList> {
  ...
  Widget build(BuildContext context) {
    final actions = <(IconData, String, String, VoidCallback)>[
      ...
      (Icons.handshake_outlined, 'CRM', 'People, notes, last orders', () => widget.onOpenTab(kOpsPermissionCrm)),
      (Icons.bar_chart_outlined, 'Analytics', 'GMV, kitchens, conversion', () => widget.onOpenTab(kOpsPermissionAnalytics)),
