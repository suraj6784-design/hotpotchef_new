-- Always refuse place when kitchen is closed (including paid Razorpay path).
-- Client must refund via recover-payment / cancel when charged.
...
BEGIN
  ...
  -- Always check — paid or unpaid. Charged failures must refund client-side.
