-- Re-price checkout from meals catalog and persist platform_margin on insert.
...
BEGIN
  ...
  INSERT INTO orders (
    ...
    COALESCE(p_delivery_fee, 0), v_packaging, COALESCE(p_tip_amount, 0), p_customer_phone, v_margin, now()
  )
